    ...
    public void run(String... args) throws Exception {
        ...
        questaoRepository.saveAll(List.of(
                ...
                alunoRepository.saveAll(List.of(
                        Aluno.builder().nome("Marcelo Gimenes").email("rm93897@fiap.com.br").senha("12345678")
                                .instituicao("Fiap").build(),
                        Aluno.builder().nome("Gustavo Balero").email("rm93090@fiap.com.br").senha("12345678")
                                .instituicao("Fiap").build(),
                        Aluno.builder().nome("Breno Massa").email("rm93797@fiap.com.br").senha("12345678")
                                .instituicao("Fiap")
                                .build(),

                        professorRepository.saveAll(List.of(
                                Professor.builder().nome("Abreu").email("pf93897@fiap.com.br").senha("12345678")
                                        .instituicao("Fiap").build(),
                                Professor.builder().nome("Jubileu Gomes").email("Pf93090@fiap.com.br").senha("12345678")
                                        .instituicao("Fiap").build(),
                                Professor.builder().nome("Thiago Yamoto").email("pf97@fiap.com.br").senha("12345678")
                                        .instituicao("Fiap").build(),

                                provaRepository.saveAll(List.of(

                                        Prova.builder().descricao("Prova de Matemática")
                                                .urlAcesso("www.fiap.com.br/matematica")
                                                .data(LocalDate.now()).ativo("ativo").build(),
                                        Prova.builder().descricao("Prova de Java").urlAcesso("www.fiap.com.br/java")
                                                .data(LocalDate.now()).ativo("ativo").build(),
                                        Prova.builder().descricao("Prova de DataBase")
