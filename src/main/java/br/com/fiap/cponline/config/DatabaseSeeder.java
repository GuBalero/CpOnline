        ...
        public void run(String... args) throws Exception {
                ...
                questaoRepository.saveAll(List.of(
                                ...
                                alunoRepository.saveAll(List.of(
                                                Aluno.builder().nome("Marcelo Gimenes").email("rm93897@fiap.com.br")
                                                                .senha("12345678")
                                                                .instituicao("Fiap").build(),
                                                Aluno.builder().nome("Gustavo Balero").email("rm93090@fiap.com.br")
                                                                .senha("12345678")
                                                                .instituicao("Fiap").build(),
                                                Aluno.builder().nome("Breno Massa").email("rm93797@fiap.com.br")
                                                                .senha("12345678")
                                                                .instituicao("Fiap")
                                                                .build(),

                                                professorRepository.saveAll(List.of(
                                                                Professor.builder().nome("Abreu")
                                                                                .email("pf93897@fiap.com.br")
                                                                                .senha("12345678")
                                                                                .instituicao("Fiap").build(),
                                                                Professor.builder().nome("Jubileu Gomes")
                                                                                .email("Pf93090@fiap.com.br")
                                                                                .senha("12345678")
                                                                                .instituicao("Fiap").build(),
                                                                Professor.builder().nome("Thiago Yamoto")
